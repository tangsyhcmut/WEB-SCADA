...
function Tem() {
  ...
  return (
    <Container className="tem-container">
      <Form>
        <h3 className="label-tem" for="tem-container">
          Temperature
        </h3>
        ...
        <Col className="temperature">
          <Row>
            <FormGroup className="temperature-display-container">
              <Label for="temperature-display-container">
                CURRENT TEMPERATURE{" "}
              </Label>
        ...
        <Col className="selectmode">
          <Row>
            <FormGroup>
              <Label>SET SYS:</Label>
              <select
                className="sys-select-mode"
                onChange={(e) => {
                  setSysSet(e.target.value);
                }}
              >
          ...
          <Button className="btn-setmode" onClick={setMode}>
            {" "}
            Set{" "}
          </Button>
          <Row>
          ...
          <Row>
            <FormGroup className="settem-container">
              <Input
                className="input-settem"
                onChange={(e) => {
                  setInputTemp(e.target.value * 10);
                }}
              />
              <Button className="btn-settem" onClick={setTemp}>
                SET
              </Button>
            </FormGroup>
          </Row>
        ...
        <Row>
          <FormGroup className="light-container">
            ...
            <Button className="btn-on" onClick={setOn}>
              ON
            </Button>
            <Button className="btn-off" onClick={setOff}>
              OFF
            </Button>
          </FormGroup>
        </Row>
